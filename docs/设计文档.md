...
API Monitor 是一个单体模块化的 API 管理、云服务管理与主机监控面板。当前技术主线是 **React 19 + Kumo 2.6 + Zustand + Go Manifest Backend + SQLite + Rust Agent**。
...
- 允许例外必须记录在 `docs/refactor-verification.md`。
