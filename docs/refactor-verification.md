...
| QR code colors | `src/js/pages/FileboxPage.jsx` | QR code dark/light colors and white QR backgrounds are functional contrast requirements. | Keep colors local to QR generation or QR image presentation. |
