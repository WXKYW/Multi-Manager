...
func (s *Service) applyManagedProxyNodeTask(taskID, id string) {
	...
	effectiveConfig, subscriberCount, err := bindManagedNodeSubscribers(ctx, db, id, protocol, secure.SecureDecrypt(configEncrypted))
	if err != nil {
