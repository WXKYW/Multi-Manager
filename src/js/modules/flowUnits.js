...
export const getFlowUnitClassName = (unit) => {
  ...
  if (normalized === 'T') return 'border-kumo-brand/65 bg-kumo-brand/25 text-kumo-brand';
  if (normalized === 'P') return 'border-kumo-danger/65 bg-kumo-danger/20 text-kumo-danger';
